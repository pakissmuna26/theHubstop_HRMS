...
while ($User = mysqli_fetch_array($Users)) {
	...
	benefits_deduction_category=\"Deduction\" AND 
	benefits_deduction_id={$User['deduction_category_id']}";
	...
	if(!$existed){
		...
		if($User['deduction_category_is_percentage'] == "Yes")
			$share="Company Share: {$User['deduction_category_company_share']}%<br>Personnel Share: {$User['deduction_category_personnel_share']}%";
		else if($User['deduction_category_is_percentage'] == "No")
			$share="Company Share: PHP ".addComma($User['deduction_category_company_share'])."<br>Personnel Share: PHP ".addComma($User['deduction_category_personnel_share'])."";
