                       ...
                       <table class="table" id="list_of_data">
                          <thead>
                            <tr>
                              ...
                              <th style="width: 20%">Current Process</th> 
...
function ListOfData(){
  ...
  $('#list_of_data').dataTable({
    ...
    "aoColumns": [
      { mData: 'number'},
      { mData: 'contract_details_for_applicant'},
    ...
    "columnDefs": [{
      ...
      "render": function ( data, type, row ) {
        ...
        if(row.application_status == "Pending"){
          button_change_status = "<a class='dropdown-item' data-bs-toggle='modal' data-bs-target='#modalChangeStatus' onclick='btnChangeStatus("+row.applicant_application_id+", \"Cancelled\", \"Cancel\")'><i class='bx bx-refresh'></i> Cancel Application</a>";
        }

        let button_manage_job_application = "<a class='dropdown-item' href='manage_my_job_application.php?id="+row.applicant_application_id+"'><i class='bx bx-list-ul'></i>Manage Application <i class='bx bx-right-arrow-alt'></i></a>";
        
        let action_button = "<button class='btn p-0' type='button' id='action_button' data-bs-toggle='dropdown' aria-haspopup='true' aria-expanded='false'><i class='bx bx-dots-vertical-rounded'></i></button><div class='dropdown-menu dropdown-menu-end'aria-labelledby='action_button'>"+button_change_status+" "+button_manage_job_application+"</div>";
